...
import { User, Building2, Mail, Lock, ShieldCheck } from "lucide-react";
...
export default function RegisterPage() {
    ...
    const getPasswordStrength = (pass: string) => {
        ...
        return { label: "Weak", color: "bg-slate-200", textColor: "text-slate-400", width: "w-0" };
    };
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!formData.fullName || !formData.username || !formData.email || !formData.password) {
            Swal.fire({
                ...
                text: 'Please fill in all required fields (Full Name, Username, Email, Password).',
    ...
    return (
        <div className="min-h-screen bg-[#f8fafc] dark:bg-[#0f172a] py-12 px-4 flex justify-center items-center transition-colors duration-300">
            ...
            <Card className="w-full max-w-2xl bg-white dark:bg-[#1e293b] border-none shadow-2xl rounded-3xl overflow-hidden animate-in fade-in zoom-in duration-500 relative">
                <div className="absolute top-6 right-8 bg-[#ffffff] dark:bg-[#1e293b] shadow rounded-lg">
                    <ModeToggle/>
                </div>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-blue-50/50  dark:bg-blue-900/10 border border-blue-100 dark:border-blue-900/30 rounded-2xl p-6 space-y-4">
                                ...
                                <div className="pl-12">
                                    <Button type="button" className="bg-[#0a355c] hover:bg-[#0a355c]/80 text-white rounded-full px-8 font-bold h-10 shadow-lg shadow-[#0a355c]/20">
                                        Send Code
                                    </Button>
                                </div>
                            </div>
                            ...
                            <Button 
                                type="submit"
                                disabled={loading}
                                className="w-full bg-[#0a355c] hover:bg-[#0a355c]/80 cursor-pointer text-white rounded-2xl h-14 text-base shadow-xl shadow-[#0a355c]/20 transition-all mt-4"
                            >
                                {loading ? (
