...
export default function LoginForm() {
    ...
    <div className="min-h-screen flex justify-center items-center px-4 bg-[#f8fafc] dark:bg-[#0f172a]">
        <div className="bg-white dark:bg-[#1e293b] p-8 rounded-2xl shadow-sm w-full max-w-sm relative">
            <div className="absolute top-3 right-3 bg-[#ffffff] dark:bg-[#1e293b] shadow rounded-lg">
                <ModeToggle/>
            </div>
